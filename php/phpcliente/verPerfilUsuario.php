...
<body>
    ...
    <div class="container">
		<div class="row">
			<div class="col-md-6 col-sm-12" id="verInformacionUsuario"></div>
			<div class="col-md-6 col-sm-12" id="verPublicacionesUsuario"></div>
		</div>
    </div>
    ...
    <script type="text/javascript">
        $.ajax({
            type: 'POST',
			url: 'listarInformacionPerfil.php',
			data: '',
			success: function(resp){
				$('#verInformacionUsuario').html(resp);
			}
        });
		
		 $.ajax({
            type: 'POST',
			url: 'listarPublicacionesPerfil.php',
			data: '',
			success: function(resp){
				$('#verPublicacionesUsuario').html(resp);
			}
        });
    </script>
