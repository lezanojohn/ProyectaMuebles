...
<!--    		<div class="col-md-1" style="position:absolute; top:75px; left:5px; z-index:99;">
    			<h6 id="volverAtras"><span class="glyphicon glyphicon-arrow-left iconoVolver"></span><a href="verProyectos.php">  volver atrás </a></h6>
    		</div>-->
    	</div>
    </div>
