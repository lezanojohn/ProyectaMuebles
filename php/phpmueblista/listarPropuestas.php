<?php
    ...
    echo 		"<div class='col-md-12 panel panel-default' style='height:350px; overflow-y:scroll;'>";
    echo "</br>";
	...
	echo				"<div class='col-md-12'>";
	echo					'<center><button type="button" onclick="Redirigir_formulario_Propuesta(\'' .$varidp .'\',\'' .$varnomp . '\')" class="btn btn-personalizado btn-lg">Hacer una propuesta</button></center>';
	echo                "</div>";
    echo            "</div>"; //column
    echo        "</div>"; //col-md-6
