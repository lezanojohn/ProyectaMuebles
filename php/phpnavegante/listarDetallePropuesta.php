<?php
    ...
    $idpr=$_POST['id_propuesta'];
     ...
     echo '<script type="text/javascript" language="javascript" src="../../js/aceptarpropuesta.js"></script>';
    ...
    function deshabilitar($estado){
		...
		echo			"<h3 style='margin-bottom:30px; margin-top:20px; text-align:center;'>Propuesta hecha por el mueblista</h3>";
