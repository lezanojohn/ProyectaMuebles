<?php
    ...
    $consulta = "SELECT p.id_propuesta, p.dias, p.id_usuario, u.nombre, p.monto, p.descripcion, u.foto_perfil, t.estado FROM propuesta p, mueblista m, usuario u, tiene t WHERE u.id_usuario = m.id_usuario and m.id_usuario = p.id_usuario and t.id_propuesta = p.id_propuesta and t.id_ideaproyecto = '$varidp'";
    ...
    while($fila = mysqli_fetch_assoc($resultado)){
        ...
        echo 			'<div  onclick="Redirigir_Propuesta(\'' .$varidp .'\',\'' .$varnomp . '\',\'' .$fila['id_propuesta'] . '\')" class="panel-body btn" style="background-color:'. $color .'; width: 100%; text-align: left;"> 
							<div class="col-md-6">
          						...
          						<strong style="margin-left:10px; line-height:40px;">'.utf8_encode($fila['nombre']) .'</strong> 
							</div>
