...
<body>
    ...
    <div class="container">
      <div class="col-md-12 divAdminPad" >
        <a href="administrarUsuarioMueblista.php">
          <center>
            <div class="col-md-6 divAdmin col-md-push-3" >
              <p class="administrarUsuarios">Mueblista</p>
            </div>
          </center>
        </a>
      </div>
        ...
        <div class="col-md-12 divAdminPad" >
          <center>
            <div class="col-md-6 divAdmin col-md-push-3" >
              <p class="administrarUsuarios">Cliente</p>
            </div>
          </center>
        </div>
      ...
      <div class="col-md-12 divAdminPad">
        <center>
          <div class="col-md-6 divAdmin col-md-push-3" >
            <p class="administrarUsuarios">Proveedor</p>
          </div>
        </center>
      </div>
