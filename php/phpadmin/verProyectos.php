...
<body>
	...
	<div class="container">
		<div class="row">
    		...
    		<div class="col-md-6 col-md-pull-6">
    			<h6 id="volverAtras"><span class="glyphicon glyphicon-home"></span><a href="verProyectos.php">  Proyectos publicados </a></h6>
    		</div>
		</div>
		<div class="row">
	...
	<script type="text/javascript">
		$.ajax({
			type: 'POST',
			url:'listarProyectos.php',
			data:'',
			success: function(resp){
				$('#verProyecto').html(resp);
			}
		});
	</script>    
