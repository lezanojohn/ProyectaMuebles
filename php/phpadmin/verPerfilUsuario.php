    ...
    <div class="container">
    	<div class="row">
    		...
    		<div class="col-md-6 col-md-pull-6">
    			<h6 id="volverAtras"><a href="verPerfilUsuario.php"><span class="glyphicon glyphicon-home"></span>  Perfil de usuario </a></h6>
    		</div>
    	</div>
		<div class="row">
			<div class="col-md-12" id="verInformacionUsuario"></div>
		</div>
    </div>
