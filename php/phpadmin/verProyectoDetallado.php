    ...
    <div class="container">
    	<div class="row">
    		...
    		<div class="col-md-6 col-md-pull-6">
    			<h6 id="volverAtras"><span class="glyphicon glyphicon-home"></span><a href="verProyectos.php">  Proyectos publicados </a><span class="glyphicon glyphicon-chevron-right"></span><a href="#" onclick="verIdeaProyecto('<?php echo $_GET['id_ideaproyecto'] ?>','<?php echo utf8_encode($_GET['nombre_proyecto']); ?>')" id="nombre_proyecto"></a></h6>
    		</div>
    	</div>
		<div class="row">
