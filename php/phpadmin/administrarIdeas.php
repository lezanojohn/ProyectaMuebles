...
<body>
    ...
    $consulta = "SELECT nombre_proyecto,id_ideaproyecto,imagen,descripcion FROM idea_proyecto";
    ...
    echo          "<div type='button'  onclick='verIdeaProyecto(" . $fila['id_ideaproyecto'] . ")' class=' col-md-5 col-xs-12 col-sm-12 cuadro_ideas'  style='background-color:#b7d0ec; margin:20px;  border-radius: 5px; height: 210px;' >";
    echo            "<h2 style='text-align: center'>" . utf8_encode($fila['nombre_proyecto']) . "</h2>";
    echo             "<center><img src='../../". $fila['imagen'] . "'  id='imgPerfilGrande' class='img-circle' alt='Responsive image'></center><br>";
    echo            "<center><button type='button' class='btn btn-primary' onclick='eliminarProyecto(".$fila['id_ideaproyecto'] .")'>Eliminar</button></center>";
    echo          "</div>";
